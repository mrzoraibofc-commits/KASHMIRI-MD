...
REPO_NAME: process.env.REPO_NAME || "KASHMIRI-MD",
BOT_NAME: process.env.BOT_NAME || "KASHMIRI-MD",
DESCRIPTION: process.env.DESCRIPTION || "KASHMIRI MD PAKISTANI POWERFULL WHATSAPP BOT",
OWNER_NUMBER: process.env.OWNER_NUMBER || "923247947238",
OWNER_NAME: process.env.OWNER_NAME || "Zoraib Official",
ST_SAVE: process.env.ST_SAVE || "KASHMIRI-MD-STATUS-SERVER",
BIO_TEXT: process.env.BIO_TEXT || "KASHMIRI-MD-BY-ARSLANMD-OFFICIAL",
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*`STATUS SEEN BY KIRA-MD`* _*POWERD BY*_ *Zoraib Official Whtsapp Bot*",
FOOTER: process.env.FOOTER || "KIRA-MD",
COPYRIGHT: process.env.COPYRIGHT || "*㋛ KASHMIRI-MD BY ZORAIB OFFICIAL*",
