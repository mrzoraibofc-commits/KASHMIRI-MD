...
// Owner numbers
const ownerNumber = ["923247947238"];
...
if (!fs.existsSync(CREDS)) {
  ...
  if (!session.includes("KASHMIRI-MD~")) {
    console.log("❌ Invalid KASHMIRI-MD session format");
    process.exit(1);
  }
  ...
  console.log("♻️ KASHMIRI-MD session restored successfully");
}
...
async function connectToWA() {
  ...
  console.log(`🤖 KASHMIRI-MD Connecting with prefix: "${prefix}"`);
  ...
  sock.ev.on('connection.update', (update) => {
    ...
    if (connection === 'close') {
      ...
      console.log("✅ KASHMIRI-MD Bot connected to WhatsApp!");
      ...
      try {
        ...
        sock.sendMessage(ownerNumber[0] + '923247947238@s.whatsapp.net', {
          image: { url: imageUrl },
          caption: aliveMsg
        }).catch(() => {
