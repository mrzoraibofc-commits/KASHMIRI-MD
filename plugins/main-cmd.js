...
console.log(`KASHMIRI-MD ♻ Auto Bio Started`);
//============================ Env=======================================================
...
async (conn, mek, m, { from, contextInfo, reply }) => {
    try {
        ...
        let envSettings = `╭━━━〔 *ASHMIRI-MD-ENV* 〕━━━┈⊷
┃▸╭───────────
┃▸┃๏ *𝔼ℕ𝕍 𝕊𝔼𝕋𝕋𝕀ℕ𝔾𝕊 📡*
┃▸└───────────···๏
╰────────────────┈⊷
...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerNumber = '+923247947238'; // Replace this with the actual owner number
        const ownerName = 'Zoraib Official'; // Replace this with the owner's name
...
try{
    ...
    let ping = await conn.sendMessage(from , { text: '*_KASHMIRI-MD..._*'  }, { quoted: mek } )
...
try{
let dec = `> KASHMIRI-MD REPO INFO 🪀

╭⦁⦂⦁*━┉━┉━┉━┉━┉━┉━⦁⦂⦁
┃ 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁: ${bot.OWNER_NUMBER}
┃ 
┃ KASHMIRI-MD REPO: ${bot.REPO_LINK} 
┃
